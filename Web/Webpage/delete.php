...
<body>
    <div class = "topNav">
        <div>
            <a href="http://localhost/PHPTesting/phptest/Web/Webpage/index.php" class="active">Home</a>
            ...
            <a href="http://localhost/PHPTesting/phptest/Web/Webpage/delete.php" class = "active">Delete</a>
        </div>
    </div>
